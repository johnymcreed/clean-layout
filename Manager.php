...
$use_auth = true;
$auth_users = array(
    'ace' => '$2y$10$RXRrtQB8TRaLvQz5FkuYDOXID2cwReDoQNHJZPw26mXDEY88giagi' // K38erdsjfsdnf0239234jd9asjdas
);
...
$favicon_path = '../../Utils/Config/Img/Logo.png';
$exclude_items = array();
                ...
                <tfoot>
                    <tr><?php if (!FM_READONLY) : ?>
                        ...
                        <td class="gray" colspan="<?php echo (!FM_IS_WIN && !$hide_Cols) ? '6' : '4' ?>">
                            <?php echo lng('FullSize') . ': <span><b>' . fm_get_filesize($all_files_size) . '</b></span>' ?>
                            <?php echo lng('File') . ': <span><b>' . $num_files . '</b></span>' ?>
                            <?php echo lng('Folder') . ': <span><b>' . $num_folders . '</b></span>' ?>
                            <?php if (function_exists('disk_free_space') && function_exists('disk_total_space')) { ?>
                                <?php echo lng('PartitionSize') . ': <span><b>' . fm_get_filesize(@disk_free_space($path)) . '</b></span> ' . lng('FreeOf') . ' <span><b>' . fm_get_filesize(@disk_total_space($path)) . '</b></span>'; ?>
                            <?php } ?>
                        </td>
                    </tr>
                </tfoot>
